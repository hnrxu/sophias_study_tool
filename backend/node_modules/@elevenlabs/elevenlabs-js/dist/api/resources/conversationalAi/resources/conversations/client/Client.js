...
const Client_6 = require("../resources/topics/client/Client");
class ConversationsClient {
    ...
    get topics() {
        var _a;
        return ((_a = this._topics) !== null && _a !== void 0 ? _a : (this._topics = new Client_6.TopicsClient(this._options)));
    }
    get analysis() {
        var _a;
